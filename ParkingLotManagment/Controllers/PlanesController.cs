...
namespace ParkingLotManagment.Controllers
{
    public class PlanesController : Controller
    {
        ...
        public PlanesController(ParkingLotManagementContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Precio,TipoPlan,TipoDeVehiculo")] Plan plan)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Precio,TipoPlan,TipoDeVehiculo")] Plan plan)
        {
            if (id != plan.Id)
            {
                return NotFound();
